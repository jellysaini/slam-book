<%@ Page Language="C#" MasterPageFile="~/RegisterUser/Pages/RegisterUser.Master" AutoEventWireup="true" CodeBehind="editFriends.aspx.cs" Inherits="SlamBook.RegisterUser.Pages.editFriends" Title="Untitled Page" %>
                                                    ...
                                                    <asp:DataList ID="fdl" runat="server" Width="100%" 
                                                        ...
                                                        <ItemTemplate>
                                                            <tr align="center">                                                            
                                                                ...
                                                                <td width="25%"><img alt="Not Found" src='../<%#Eval("ImageName")%>' class="imgtag" width="100px" height="130px" /></td>
                                                                <td width="55%">
                                                                ...
                                                                <td width="10%">                                                                   
                                                                   <asp:LinkButton ID="delete" CommandArgument='<%#Eval("UserId") %>' CommandName="delete" Text="Delete" runat="server"></asp:LinkButton>
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%">
                                            <tr align="center">
                                                <td width="15%"></td>
                                                <td width="14%"><asp:LinkButton ID="first" Text="First" runat="server" 
                                                        onclick="first_Click" ></asp:LinkButton></td>
                                                <td width="14%"><asp:LinkButton ID="prev" Text="Previous" runat="server" 
                                                        onclick="prev_Click" ></asp:LinkButton></td>
                                                <td width="14%"><asp:Label ID="pno" Text=" " runat="server"></asp:Label></td>
                                                <td width="14%"><asp:LinkButton ID="next" Text="Next" runat="server" 
                                                        onclick="next_Click" ></asp:LinkButton></td>
                                                <td width="14%"><asp:LinkButton ID="last" Text="Last" runat="server" 
                                                        onclick="last_Click" ></asp:LinkButton></td>
                                                <td width="15%"></td>
                                            </tr>
                                        </table>
                                    </td>
