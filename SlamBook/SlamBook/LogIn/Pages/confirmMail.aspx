<%@ Page Language="C#" MasterPageFile="~/LogIn/Pages/MyLogInMaster.Master" AutoEventWireup="true" CodeBehind="confirmMail.aspx.cs" Inherits="SlamBook.LogIn.Pages.confirmMail" Title="Untitled Page" %>
        ...
        <tr>
            <td width="100%">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr align="center" >
                        <td><h2><font color="#ff6600"><asp:Label ID="msg" runat="server" Text=" "></asp:Label></font></h2>
                        </td>
                    </tr>
                    <tr align="center">
                        <td><h2><font color="#ff6600"><asp:LinkButton ID="movetologin" runat="server" 
                                Text="Click to Login again" onclick="movetologin_Click"></asp:LinkButton></font></h2></td>
                    </tr>
                    <tr><td><br />&nbsp;</td></tr>
                </table> 
            </td>
